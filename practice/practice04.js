...
if(t3ASCII >= 65 && t3ASCII <= 90) console.log(`'${t3character}' is an uppercase letter`);
else if(t3ASCII >= 97 && t3ASCII <= 122) console.log(`'${t3character}' is a lowercase letter`);
...
if((t4ASCII >= 48 && t4ASCII <= 57) || (t4ASCII >= 65 && t4ASCII <= 90) || (t4ASCII >= 97 && t4ASCII <= 122) || (t4ASCII === 32)) console.log(`"${t4character}" is not a special character`);
